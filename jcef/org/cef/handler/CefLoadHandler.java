...
public interface CefLoadHandler {
   void onLoadingStateChange(CefBrowser var1, boolean var2, boolean var3, boolean var4);

   void onLoadStart(CefBrowser var1, CefFrame var2, CefRequest.TransitionType var3);

   void onLoadEnd(CefBrowser var1, CefFrame var2, int var3);

   void onLoadError(CefBrowser var1, CefFrame var2, CefLoadHandler.ErrorCode var3, String var4, String var5);
   ...
   public static enum ErrorCode {
      ...
      private static final Map<Integer, CefLoadHandler.ErrorCode> CODES = new HashMap<>();
      ...
      public static CefLoadHandler.ErrorCode findByCode(int var0) {
         return CODES.get(var0);
      }

      static {
         for (CefLoadHandler.ErrorCode var3 : values()) {
            if (!CODES.containsKey(var3.code)) {
               CODES.put(var3.code, var3);
            }
         }
      }
   }
