...
public abstract class CefDragData {
   ...
   public abstract int getFileContents(OutputStream var1);

   public abstract String getFileName();

   public abstract boolean getFileNames(Vector<String> var1);

   public abstract void setLinkURL(String var1);

   public abstract void setLinkTitle(String var1);

   public abstract void setLinkMetadata(String var1);

   public abstract void setFragmentText(String var1);

   public abstract void setFragmentHtml(String var1);

   public abstract void setFragmentBaseURL(String var1);

   public abstract void resetFileContents();

   public abstract void addFile(String var1, String var2);
